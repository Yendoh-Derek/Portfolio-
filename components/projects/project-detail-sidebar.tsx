    ...
    <aside className="lg:col-span-4 space-y-8">
      <div className="obsidian-card p-8 space-y-6 sticky top-24">
        ...
        <button
          ...
          className="w-full py-4 rounded-full bg-primary text-white font-bold flex items-center justify-center gap-2 hover:opacity-95 transition-all hover:scale-[1.02] shadow-[0_0_20px_rgba(138,43,226,0.35)] hover:shadow-[0_0_30px_rgba(138,43,226,0.55)]"
        >
          <SparkleIcon size={18} />
